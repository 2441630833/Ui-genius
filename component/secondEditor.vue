...
export default {
    data() {
        return {
            ...
            iframeLoaded: false,
            checkInterval: null,
            currentLocale: uni.getStorageSync('appLocale') || 'en'
        };
    },
    watch: {
    ...
    computed: {
        editorTranslations() {
            return {
                titleFileManager: this.$t('editor.titleFileManager'),
                titleLeftColumn: this.$t('editor.titleLeftColumn'),
                titleRightColumn: this.$t('editor.titleRightColumn'),
                titleUndo: this.$t('editor.titleUndo'),
                titleRedo: this.$t('editor.titleRedo'),
                titlePreview: this.$t('editor.titlePreview'),
                titleFullscreen: this.$t('editor.titleFullscreen'),
                titleLayers: this.$t('editor.titleLayers'),
                titleDownload: this.$t('editor.titleDownload'),
                savePage: this.$t('editor.savePage'),
                saving: this.$t('editor.saving'),
                saved: this.$t('editor.saved'),
                titleMobile: this.$t('editor.titleMobile'),
                titleTablet: this.$t('editor.titleTablet'),
                titleDesktop: this.$t('editor.titleDesktop'),
                pages: this.$t('editor.pages'),
                newPage: this.$t('editor.newPage'),
                sections: this.$t('editor.sections'),
                components: this.$t('editor.components'),
                blocks: this.$t('editor.blocks'),
                pageSections: this.$t('editor.pageSections'),
                searchSections: this.$t('editor.searchSections'),
                searchComponents: this.$t('editor.searchComponents'),
                searchBlocks: this.$t('editor.searchBlocks'),
                noSelectedElement: this.$t('editor.noSelectedElement'),
                clickToEdit: this.$t('editor.clickToEdit'),
                content: this.$t('editor.content'),
                style: this.$t('editor.style'),
                advanced: this.$t('editor.advanced'),
                variables: this.$t('editor.variables'),
                css: this.$t('editor.css'),
                dragElement: this.$t('editor.dragElement'),
                selectParent: this.$t('editor.selectParent'),
                moveUp: this.$t('editor.moveUp'),
                moveDown: this.$t('editor.moveDown'),
                editCode: this.$t('editor.editCode'),
