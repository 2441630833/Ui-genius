...
export default {
  ...
  data() {
    return {
      ...
      modelOptions: [
        { value: 'gemini-3.1-pro-preview', text: 'google/gemini-3.1-pro-preview', isPro: true },
        { value: 'gemini-3-flash-preview', text: 'google/gemini-3-flash-preview', isPro: true },
        { value: 'kimi-k2.5', text: 'kimi/kimi-k2.5', isPro: true },
        { value: 'MiniMax-M2.7', text: 'MiniMax/MiniMax-M2.7', isPro: true },
        { value: 'glm-4.7', text: 'ChatGLM/glm-4.7', isPro: true },
      ],
      selectedPageModel: 'gemini-3-flash-preview',
